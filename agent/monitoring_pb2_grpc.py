...
class MonitoringServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SendMetrics = channel.unary_unary(
                ...
                request_serializer=monitoring__pb2.MetricRequest.SerializeToString,
                response_deserializer=monitoring__pb2.MetricResponse.FromString,
...
def add_MonitoringServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'SendMetrics': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=monitoring__pb2.MetricRequest.FromString,
                    response_serializer=monitoring__pb2.MetricResponse.SerializeToString,
            ),
    }
...
class MonitoringService(object):
    ...
    def SendMetrics(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/monitoring.MonitoringService/SendMetrics',
            monitoring__pb2.MetricRequest.SerializeToString,
            monitoring__pb2.MetricResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
